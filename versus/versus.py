...
class Versus():
    ...
    def create_button(self):
        self.move_btn = pg.Rect((2 * TILESIZE, HEIGHT - TILESIZE), (TILESIZE, HEIGHT))
        self.attack_btn = pg.Rect((0, HEIGHT - TILESIZE), (TILESIZE, HEIGHT))
        self.spell_btn = pg.Rect((TILESIZE, HEIGHT - TILESIZE), (TILESIZE, HEIGHT))
    ...
    def draw(self, surface):
        pg.draw.rect(surface, RED, self.attack_btn.copy())
        pg.draw.rect(surface, YELLOW, self.move_btn.copy())
        pg.draw.rect(surface, BLUE, self.spell_btn.copy())
    ...
    def isMOV(self):
        return self.move_btn.collidepoint(self.mouse_pos[0], self.mouse_pos[1])

    def isATK(self):
        return self.attack_btn.collidepoint(self.mouse_pos[0], self.mouse_pos[1])

    def isSRT(self):
        return self.spell_btn.collidepoint(self.mouse_pos[0], self.mouse_pos[1])
    ...
    def rangeATK(self, surface, player):
        if player.weapon != None:
            ...
            self.CircleATK = pg.Rect(
                (player.pos.x - (TOUCH_HAND + 1) * TILESIZE, player.pos.y - (TOUCH_HAND + 1) * TILESIZE),
                ((TOUCH_HAND + 1) * TILESIZE * 2, (TOUCH_HAND + 1) * TILESIZE * 2))
