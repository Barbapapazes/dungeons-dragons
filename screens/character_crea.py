...
class Character_crea(_State):
    ...
    def __init__(self):
        ...
        self.str = Curseur(
            ...
            1)
        self.dex = Curseur(
            "DEX", 700, 420, 200, 20, self.background, self.list_perso[self.index][4][1],
            self.list_perso[self.index][4][2] - self.list_perso[self.index][4][1],
            1)
        self.con = Curseur(
            "CON", 700, 490, 200, 20, self.background, self.list_perso[self.index][5][1],
            self.list_perso[self.index][5][2] - self.list_perso[self.index][5][1],
            1)

        self.int = Curseur(
            "INT", 20, 350, 200, 20, self.background, self.list_perso[self.index][5][1],
            self.list_perso[self.index][5][2] - self.list_perso[self.index][5][1],
            1)
        self.wis = Curseur(
            "WIS", 20, 420, 200, 20, self.background, self.list_perso[self.index][5][1],
            self.list_perso[self.index][5][2] - self.list_perso[self.index][5][1],
            1)
        self.cha = Curseur(
            "CHA", 20, 490, 200, 20, self.background, self.list_perso[self.index][5][1],
            self.list_perso[self.index][5][2] - self.list_perso[self.index][5][1],
            1)
